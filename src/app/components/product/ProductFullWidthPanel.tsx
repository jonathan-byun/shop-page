...
const ProductFullWidthPanel: FC<ProductFullWidthPanelProps> = ({ title, listItems, photoUrl }) => {
        ...
        <div className='basis-2/5 flex flex-col justify-center items-center'>
            <div className='flex flex-col gap-8'>
                ...
                {listItems.map((item,i) => {
                    return (
                        <button key={item.name} onClick={()=>setCurrentSelection(i)} className='flex group items-center gap-2'>
